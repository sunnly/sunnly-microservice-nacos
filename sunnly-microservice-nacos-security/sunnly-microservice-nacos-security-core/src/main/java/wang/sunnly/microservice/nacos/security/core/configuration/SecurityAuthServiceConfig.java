package wang.sunnly.microservice.nacos.security.core.configuration;
...
import wang.sunnly.microservice.nacos.security.core.config.SecurityAuthConfig;
...
import wang.sunnly.microservice.nacos.security.core.service.SecurityAuthServiceService;
...
public class SecurityAuthServiceConfig {
    ...
    public IJWTInfo getInfoFromToken(String token) throws Exception{
        try {
            return JWTHelper.getInfoFromToken(token,securityAuthConfig.getPubKeyByte());
